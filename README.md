...
You can download the latest pre-compiled APKs from the [Releases](https://github.com/not-ayan/Wallwidgy_Android/releases) page. Alternatively, unsigned testing APKs are automatically generated by GitHub Actions and can be found on the [Build Workflow](https://github.com/not-ayan/Wallwidgy_Android/actions/workflows/build.yml) page.
